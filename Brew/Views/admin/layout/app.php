...
<body class="h-full bg-admin-bg" x-data="{ sidebarOpen: true, mobileMenu: false }">
    <div class="flex h-full">
        ...
        <aside class="fixed inset-y-0 left-0 z-30 flex flex-col bg-admin-sidebar text-white transition-all duration-300"
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                $menuItems = [
                    ...
                    ['label' => 'Websites', 'url' => '/admin/stores/websites', 'icon' => 'M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9', 'section' => 'stores'],
        ...
        <div class="flex-1 transition-all duration-300" :class="sidebarOpen ? 'ml-64' : 'ml-20'">
            ...
            <!-- Flash Messages -->
            <?php if ($flash = \Brew\Core\Session::getFlash('success')): ?>
            ...
            <?php endif; ?>
            <?php if ($flash = \Brew\Core\Session::getFlash('error')): ?>
