...
<section class="bg-[var(--color-bg)]">
    <div class="mx-auto w-[92%] sm:w-[90%] md:w-[88%] lg:w-[85%] py-14">
        <div class="rounded-2xl bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 text-white p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <div class="relative">
                ...
                <div class="mt-6 flex justify-center gap-3">
                    ...
                    <a href="/contact" class="inline-flex h-12 items-center gap-2 rounded-[var(--radius-button)] border border-white/25 bg-white/10 px-6 text-sm font-semibold text-white transition hover:bg-white/20">
                        Contact Us
                    </a>
                </div>
            </div>
