...
<section class="bg-[var(--color-surface)]">
    <div class="mx-auto w-[92%] sm:w-[90%] md:w-[88%] lg:w-[85%] py-14">
        ...
        <div class="grid md:grid-cols-4 gap-6 relative">
            ...
            <div class="hidden md:block absolute top-10 left-[12.5%] right-[12.5%] h-0.5 bg-gradient-to-r from-[var(--color-accent)]/20 via-[var(--color-accent)]/40 to-[var(--color-accent)]/20"></div>
            ...
            <div class="relative text-center">
                <div class="mx-auto w-14 h-14 rounded-2xl bg-[var(--color-accent)] text-white flex items-center justify-center text-lg font-bold mb-4 relative z-10">2</div>
                <h3 class="text-base font-semibold text-[var(--color-text)] mb-1">Add to Cart</h3>
                <p class="text-sm text-[var(--color-muted)] leading-relaxed">Pick your favourites, compare features, and add them to your cart.</p>
            </div>

            <div class="relative text-center">
                <div class="mx-auto w-14 h-14 rounded-2xl bg-[var(--color-accent)] text-white flex items-center justify-center text-lg font-bold mb-4 relative z-10">3</div>
                <h3 class="text-base font-semibold text-[var(--color-text)] mb-1">Checkout</h3>
                <p class="text-sm text-[var(--color-muted)] leading-relaxed">Pay securely with your preferred method. SSL encrypted, always.</p>
            </div>
