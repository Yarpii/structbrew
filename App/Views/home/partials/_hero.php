...
<section class="relative overflow-hidden bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 text-white">
    ...
    <div class="relative mx-auto w-[92%] sm:w-[90%] md:w-[88%] lg:w-[85%] py-16 md:py-24">
        <div class="max-w-2xl">
                ...
                New parts just dropped
            </span>
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.1]">
                Parts that keep<br>
                <span class="bg-gradient-to-r from-[var(--color-accent)] to-orange-400 bg-clip-text text-transparent">you rolling.</span>
            </h1>
            <p class="mt-5 text-lg text-gray-300 leading-relaxed max-w-lg">
                Discover quality scooter parts, accessories and upgrades. Curated for performance, built for the road.
            </p>
            <div class="mt-8 flex flex-wrap gap-3">
                ...
                <a href="/shop?category=accessories" class="inline-flex h-12 items-center gap-2 rounded-[var(--radius-button)] border border-white/25 bg-white/10 px-6 text-sm font-semibold text-white transition hover:bg-white/20">
                    Browse Accessories
                </a>
            </div>
        </div>
