<section class="mx-auto w-full max-w-6xl space-y-6 px-4 py-10 sm:px-6 lg:px-8" x-data="{ loading: false, selectedDepartment: '' }">
    <div class="rounded-md border border-[var(--color-border)] bg-[var(--color-surface)]/90 p-6 sm:p-8" style="box-shadow: var(--shadow-sm)">
        <h1 class="text-3xl font-bold tracking-tight text-[var(--color-text)]">Contact Support</h1>
        <p class="mt-2 text-[var(--color-muted)]">Send us a message and choose the right department in the form below.</p>
    </div>
