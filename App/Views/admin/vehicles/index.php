    ...
    <form method="GET" action="/admin/vehicles" class="p-4 flex flex-wrap gap-4 items-end">
        ...
        <div class="w-48">
            ...
            <select name="brand" class="w-full px-3 py-2 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <option value="<?= (int) $vb['id'] ?>" <?= ($_GET['brand'] ?? '') == $vb['id'] ? 'selected' : '' ?>>
            ...
            <tbody class="divide-y divide-gray-100">
                <?php if (!empty($vehicles['data'])): ?>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-3">
                            <a href="/admin/vehicles/<?= (int) $vehicle['id'] ?>/edit" class="font-medium text-gray-900 hover:text-blue-600">
                        ...
                        <td class="px-6 py-3 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="/admin/vehicles/<?= (int) $vehicle['id'] ?>/edit" class="p-1.5 text-gray-400 hover:text-blue-600 rounded-lg hover:bg-blue-50" title="Edit">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                </a>
                                <form method="POST" action="/admin/vehicles/<?= (int) $vehicle['id'] ?>/delete" onsubmit="return confirm('Delete this vehicle?')">
