    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 gap-4 xl:grid-cols-2">
            <div class="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-5 md:p-7" style="box-shadow: var(--shadow-sm)">
                ...
                <form class="space-y-4" method="POST" action="/login" @submit="loading = true">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="login-email" name="email" type="email" required autocomplete="email" placeholder="name@example.com" spellcheck="false"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="login-pass" name="password" :type="showPass ? 'text' : 'password'" required autocomplete="current-password" placeholder="Your password"
            ...
            <div class="rounded-2xl border border-[var(--color-border)] bg-[var,--color-surface)] p-5 md:p-7" style="box-shadow: var(--shadow-sm)">
                ...
                <ul class="space-y-2.5 text-sm">
                    ...
                    <li class="flex items-start gap-2.5 rounded-lg border border-[var,--color-border)] bg-[var,--color-bg)] px-3 py-2.5">
                        <svg class="shrink-0 mt-0.5" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var('--color-accent')" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        <span class="text-[var,--color-text)]">Personal account overview</span>
                    </li>
                    <li class="flex items-start gap-2.5 rounded-lg border border-[var,--color-border)] bg-[var,--color-bg)] px-3 py-2.5">
                        <svg class="shrink-0 mt-0.5" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var('--color-accent')" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
